...
<body>
    <header>
      <div class="logo">
         <a href="al.html"> <span> <strong> LS </strong> <em>formation</em>  </span></a>
      </div>
        <strong>
         <ul class="menu">
            <li> <a href="al.php">accueuil </a> </li>
            <li> <a href="offre.html">offre </a> </li>
            <li> <a href="inscript.php">M'inscire </a> </li>
            <li> <a href="conn.php">Me connecter </a> </li>
         </ul>
        </strong>
...
<div class="corp">
   ...
   <div class="cor">
      ...
      <div class="card">
         ...
         <div class="card1">
            <img src="/image Capture.PNG" alt="" width="100px" height="90px">
            <p>Email</p>
            <p> <em> kellyandell9@gmail.com</em></p>
         </div>

         <div class="card2">
            <img src="/image/1.PNG" alt=""width="100px" height="90px">
            <p>Téléphone</p>
            <p> <em>+261 34 84 856 35</em> </p>
         </div>

         <div class="card3">
            <img src="/image/téléchargement.png" alt=""width="100px" height="70px">
              <p>facebook</p>
